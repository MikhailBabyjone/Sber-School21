...
void calc_max_row(int** matrix, int n, int m, int* max_row);
void calc_min_col(int** matrix, int n, int m, int* min_col);
...
int main() {
    ...
    if (ok) {
        calc_max_row(matrix, n, m, max_row);
        calc_min_col(matrix, n, m, min_col);
        output(matrix, n, m);
        printf("\n");
        output_array(max_row, n);
        printf("\n");
        output_array(min_col, m);
    }
